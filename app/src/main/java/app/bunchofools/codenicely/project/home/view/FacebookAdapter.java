...
import app.bunchofools.codenicely.project.home.model.data.FbDetails;
            ...
            otherViewHolder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if( context instanceof HomeActivity){
                        ...
                        ((HomeActivity) context).openImageViewerFacebook(fbDetailsList.get(position).getAttachments().getData(),position);
